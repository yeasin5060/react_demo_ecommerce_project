    ...
    <section id='customer'>
        <div className='container'>
            <div className='customer_wrapper'>
                {
                    arr.map((item) =>(
                        <div className='customer_product_box'>
                            <div className='customer_product_image'>
                                <img src={item.img} alt="not found"/>
                            </div>
                            <div className='customer_product_names'>
                                <h4 className='product_names'>{item.name}</h4>
                                <h5 className='product_review'>{item.review}</h5>
                                <Pera text={item.price} style="prices"/>
                                <h5 className='old_prices'>{item.oldPrice}</h5>
                            </div>
                        </div>
                    ))
                }
            </div>
            <div className='sgin_in_box'>
                <Pera text="See personalized recommendations" style="sgin_in_pera"/>
                <button className='sgin_in_btn'>sgin in</button>
                <p className='new_customer'>new customer <span className='start_here'>start here</span></p>
            </div>
        </div>
    </section>
  )
